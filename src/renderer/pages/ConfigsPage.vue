...
function save() {
    Object.assign(projectConfigStore, {
        width: width.value,
        height: height.value,
        ppi: ppi.value,
    ...
    <ContentPad>
        <div class="column h-full w-full justify-between">
            <div>
                                ...
                                <q-menu :model-value="true" anchor="top right" self="top left">
                                    <q-list style="min-width: 100px">
                                        <q-item
                                            clickable
                                            v-close-popup
                                            v-for="option in commonPagesSizes"
                ...
                <div class="text-gray-500 mb-2">{{ convertToPixels(width, ppi).toFixed(0) }}X{{ convertToPixels(height, ppi).toFixed(0) }}px</div>
