...
<template>
    <ContentPad>
        ...
        <q-btn class="mr-2 mb-4" push icon="add" align="left" @click="onNewProject()" no-caps>New
            project</q-btn>
        <q-btn class="mb-4" push icon="save" align="left" @click="onLoadProject()" no-caps>Load
            project</q-btn>
