...
const isValid = computed(
    () =>
        !!pipeline.value.name &&
        isValidName(pipeline.value.name) &&
        (!Object.keys(exportPipelinesStore.exportPipelines).includes(pipeline.value.name) || pipeline.value.name === pipelineName),
)
        ...
        <div class="column container">
            ...
            <div class="col row">
                ...
                <div class="column col h-full w-full">
                    <Filterbar
                        class="my-2 ml-3 p-2"
                        v-model:cardSize="projectConfigStore.filters.editExport.cardSize"
                    ...
                    <q-scroll-area class="col h-full w-full">
                        <div class="col page-container m-3 fit row wrap justify-start items-start content-start" ref="pageContainer"></div>
                    </q-scroll-area>
                </div>
            </div>
